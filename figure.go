...
//
///*
//соблюден ли принцип единственной ответственности в данной схеме ?
//если нужно будет поменять принцип рисования фигуры треугольника (изменятся требования), то что придётся делать, и как тут будут соблюдаться принципы открытости/закрытости и разделения интерфейса ?
//если добавится новое требование для обработки фигуры, например, посчитать его периметр или площадь, то как это нужно будет реализовать ?
//*/
//
